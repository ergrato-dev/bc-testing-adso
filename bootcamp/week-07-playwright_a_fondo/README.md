...
|---|---|---|
| [Semana 6 — Integración con BD real](../week-06-integracion_con_bd/README.md) | [README del bootcamp](../../README.md) | Semana 8 — CI completo y calidad de la suite *(pendiente)* |
